...
A simple desktop application that helps you do more with screen shots.

- :clipboard: Copy image file to clipboard.
- :put_litter_in_its_place: Chage where you save screen shots
- :sunrise_over_mountains: Disable Mojave's new screen capture utility


## Installation Guide

:arrow_down: [Download the latest version] (Mac only)

The  current version is not  signed so you will open the dmg by right clicking and opening from that menu.

![unsigned](assets/docs/how_to_open_unsigned.png)
...
:camera: > :camera: > :outbox_tray:

### :camera: Take screen shot
...
This can happen automatically or  you can choose to get prompted.

### :outbox_tray: Paste Image
Most modern web applications let you past image right into the form or textarea.
